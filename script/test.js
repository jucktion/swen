...
Vue.component('partabs', {
    ...
    <div>
        <div class="tabs is-centered is-toggle navbar is-toggle-rounded">
            <ul>
                <li v-for="tab in chitabs" :class="{'is-active': tab.isActive}"><a @click="selectTab(tab)" href="#">{{tab.title}}</a></li>
            </ul>
        </diV>
...
Vue.component('tabs', {
    ...
    <div class="content childcontent">
        <div class="tabs child is-centered is-toggle navbar is-toggle-rounded">
            <ul>
                <li v-for="tab in tabs" :class="{'is-active': tab.isActive}"><a @click="selectTab(tab)" href="#">{{tab.title}}</a></li>
            </ul>
        </div>
        <div class='tab-details'>
            <slot></slot>
...
Vue.component('tab', {
    ...
    <div :id="this.name.toLowerCase()" v-show="isActive" class='tab-details'>
        ...
        <li v-for="link in this.linklist"><a v-if="link.rurl" target="_blank" :href="'https://reddit.com'+link.rurl">[{{link.score}}]</a> - <a target="_blank" :href="link.url">{{link.title}}</a> </li>
        </ul>
        <slot></slot>
    </div>
    `,
